      ...
      >
        ...
        <motion.div variants={fadeUp} className="mb-4">
          ...
          <div className="mt-2 flex items-center gap-3 h-14 px-4 rounded-2xl bg-surface ring-1 ring-border focus-within:ring-violet/60 transition">
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none font-mono text-base placeholder:text-text-secondary/60"
            />
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeUp}>
          <RippleButton
            ...
            onClick={() => nav({ to: "/otp" })}
          >
            <Phone className="w-4 h-4" /> Continue with OTP
          </RippleButton>
        </motion.div>
        ...
        >
          ...
          <Link to="/" className="text-violet-light">
            Terms
          </Link>{" "}
          &{" "}
          <Link to="/" className="text-violet-light">
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48">
      <path
        fill="#FFC107"
        d="M43.6 20.5H42V20H24v8h11.3C33.6 32.9 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 19.7-8 19.7-20 0-1.2-.1-2.3-.1-3.5z"
      />
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8C14.6 16.1 19 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34 6.1 29.3 4 24 4 16.3 4 9.7 8.3 6.3 14.7z"
      />
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 9.9-2 13.5-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.3 2.4-5.2 0-9.5-3.1-11.3-7.5l-6.5 5C9.5 39.6 16.2 44 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.9 2.5-2.6 4.6-4.8 6l6.2 5.2c-.4.4 6.8-4.9 6.8-15.2 0-1.2-.1-2.3-.1-3.5z"
      />
    </svg>
  );
}
